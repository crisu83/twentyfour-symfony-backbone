...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/www/GitHub/twentyfour/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    {
        require_once 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_7663911d7ec7d3a2dd4d9d0f1296cc98');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_7663911d7ec7d3a2dd4d9d0f1296cc98');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7663911d7ec7d3a2dd4d9d0f1296cc98');
        ...
        $d->setProxyDir('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/www/GitHub/twentyfour/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/www/GitHub/twentyfour/Symfony/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod',
            ...
            'session.save_path' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/www/GitHub/twentyfour/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager.php',
            ...
            'security.extra.cache_dir' => 'D:/www/GitHub/twentyfour/Symfony/app/cache/prod/jms_security',
